...
def calculate_over_under(df):
    ...
    - 'Fulltime Home Over 1.5', 'Fulltime Home Over 2.5', 'Fulltime Home Over 3.5'
    - 'Fulltime Away Over 1.5', 'Fulltime Away Over 2.5', 'Fulltime Away Over 3.5'
    - 'Fulltime Over 1.5', 'Fulltime Over 2.5', 'Fulltime Over 3.5'
